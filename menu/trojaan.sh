...
VALIDITY () {
    ...
    Exp1=$(curl -sS https://raw.githubusercontent.com/Zerovpn3/vpn/main/listip | grep $MYIP | awk '{print $4}')
    if [[ $today < $Exp1 ]]; then
...
IZIN=$(curl -sS https://raw.githubusercontent.com/Zerovpn3/vpn/main/listip | awk '{print $5}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
...
echo -e "\e[$line═════════════════════════════════\e[m"
echo -e "DI BACA ‼️ $creditt Shop"
echo -e "DILARANG MENGGUNAKAN (ID akan di ban & Tanpa refund)"
...
echo -e "allowInsecure : True/allow"
echo -e "\e[$line═════════════════════════════════\e[m"
echo -e "DIBACA  $creditt Shop"
echo -e "DI BACA ‼️ DILARANG MENGGUNAKAN (ID akan di ban & Tanpa refund)"
echo -e "\e[31m❌ Torrent (p2p, streaming p2p)"
echo -e "\e[31m❌ PS4"
echo -e "\e[31m❌ Porn"
echo -e "\e[31m❌ Spam Bug"
