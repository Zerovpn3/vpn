...
# Licence: Arnold
# Author:  Arnold-store.blogspot.com
...
#                           Patch from arayling74@gmail.com
...
#                           Reported by Arnold <arvidjaar@mail.ru>
# V3.8      17 Jun 2016
...
#
# Programs that use CLONE_VM without CLONE_THREAD are discounted by arnold
