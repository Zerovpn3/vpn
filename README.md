# Script ARNOLD V8-Websocket
 SELAMAT DATANG SEMUA 😊

 <h2 align="center">AutoScript VPN By ARNOLD <img src="https://img.shields.io/badge/Version-6.0-blue.svg"></h2>
...
## INSTALLATION SCRIPT
  ...
  ```html
  wget https://raw.githubusercontent.com/Zerovpn3/vpn/main/setup.sh && chmod +x setup.sh && sed -i -e 's/\r$//' setup.sh && screen -S setup ./setup.sh
...
## Description :
 ...
 >>> Server Information & Other Features
   - Timezone                 : Asia/INDONESIA_BARAT (GMT +7)
   - Fail2Ban                 : [ON]
   - DDOS Dflate              : [ON]
   - IPtables                 : [ON]
