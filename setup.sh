...
VALIDITY() {
    ...
    if [[ $today < $Exp1 ]]; then
        echo -e "\e[32mAnda telah menggunakan AUTO SCRIPT ZEROVPN..\e[0m"
        sleep 5
    else
...
#install cf
wget https://raw.githubusercontent.com/${GitUser}/zerovpn3/main/install/cf.sh && chmod +x cf.sh && ./cf.sh
rm -f /root/cf.sh
clear
else
...
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/zerovpn3/main/install/ssh-vpn.sh && chmod +x ssh-vpn.sh && screen -S ssh-vpn ./ssh-vpn.sh
echo -e "\e[0;32mDONE INSTALLING SSH & OVPN\e[0m"
clear
#install Xray
echo -e "\e[0;32mINSTALLING XRAY CORE...\e[0m"
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/zerovpn3/main/install/ins-xray.sh && chmod +x ins-xray.sh && screen -S ins-xray ./ins-xray.sh
echo -e "\e[0;32mDONE INSTALLING XRAY CORE\e[0m"
clear
#install ohp-server
echo -e "\e[0;32mINSTALLING OHP PORT...\e[0m"
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/zerovpn3/main/install/ohp.sh && chmod +x ohp.sh && ./ohp.sh
wget https://raw.githubusercontent.com/${GitUser}/zerovpn3/main/install/ohp-dropbear.sh && chmod +x ohp-dropbear.sh && ./ohp-dropbear.sh
wget https://raw.githubusercontent.com/${GitUser}/zerovpn3/main/install/ohp-ssh.sh && chmod +x ohp-ssh.sh && ./ohp-ssh.sh
echo -e "\e[0;32mDONE INSTALLING OHP PORT\e[0m"
clear
#install websocket
echo -e "\e[0;32mINSTALLING WEBSOCKET PORT...\e[0m"
wget https://raw.githubusercontent.com/${GitUser}/zerovpn3/main/websocket-python/websocket.sh && chmod +x websocket.sh && screen -S websocket.sh ./websocket.sh
echo -e "\e[0;32mDONE INSTALLING WEBSOCKET PORT\e[0m"
clear
#install SET-BR
echo -e "\e[0;32mINSTALLING SET-BR...\e[0m"
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/zerovpn3/main/install/set-br.sh && chmod +x set-br.sh && ./set-br.sh
...
echo "   - Timezone                : Asia/INDONESIA_BARAT (GMT +7)"  | tee -a log-install.txt
...
echo -e "\e[1;32m══════════════════Autoscript ZERO VPN══════════════════\e[0m" | tee -a log-install.txt
sleep 7
clear
echo ""
echo -e "    \e[1;32m.------------------------------------------.\e[0m"
echo -e "    \e[1;32m|     SUCCES INSTALL SCRIPT     |\e[0m"
echo -e "    \e[1;32m|         PREMIUM BY @arnold339          |\e[0m"
echo -e "    \e[1;32m'------------------------------------------'\e[0m"
echo ""
